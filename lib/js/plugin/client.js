...
NW.event = (function(){
    return {
        start : 'MSPointerDown' in window ? 'MSPointerDown' : NW.support.isMobile ? 'touchstart' : 'click',
        move : 'MSPointerDown' in window ? 'MSPointerMove' : NW.support.isMobile ? 'touchmove' : 'mousemove',
        end : 'MSPointerDown' in window ? 'MSPointerUp' : NW.support.isMobile ? 'touchend' : 'click',
